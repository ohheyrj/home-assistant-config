...
HACS | HACS gives you a powerful UI to handle downloads of all your custom needs. | 1.21.0 | https://github.com/hacs/integration
...
Hp Printers Integration | HP Printer Integration | v1.0.6 | https://github.com/elad-bar/ha-hpprinter
Node Red Companion | Companion Component for node-red-contrib-home-assistant-websocket to help integrate Node-RED with Home Assistant Core | v1.0.6 | https://github.com/zachowj/hass-node-red
Spotcast | Home assistant custom component to start Spotify playback on an idle chromecast device as well as control spotify connect devices | v3.6.24 | https://github.com/fondberg/spotcast
Tapo: Cameras Control | Control for Tapo cameras as a Home Assistant component | 3.4.4 | https://github.com/JurajNyiri/HomeAssistant-Tapo-Control
...
Person | Minimalist plugin which allows users to add person entity in order to show the location with a beutiful and clean interface. | v0.7.5 | https://github.com/gerardag/person-entity-card
