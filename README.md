...
[![HA Version](https://img.shields.io/badge/Home%20Assistant-2021.12.3-brightgreen)](https://github.com/home-assistant/home-assistant/releases/2021.12.3)
...
Google Home | Home Assistant Google Home custom component  | v1.9.3 | https://github.com/leikoilja/ha-google-home
Govee | A HACS repository for Govee light integration | 0.2.1 | https://github.com/LaggAt/hacs-govee
HACS | HACS gives you a powerful UI to handle downloads of all your custom needs. | 1.18.0 | https://github.com/hacs/integration
...
Hp Printers Integration | HP Printer Integration | v1.0.5 | https://github.com/elad-bar/ha-hpprinter
Node Red Companion | Companion Component for node-red-contrib-home-assistant-websocket to help integrate Node-RED with Home Assistant Core | v0.5.4 | https://github.com/zachowj/hass-node-red
Spotcast | Home assistant custom component to start Spotify playback on an idle chromecast device as well as control spotify connect devices | v3.6.23 | https://github.com/fondberg/spotcast
Tapo: Cameras Control | Control for Tapo cameras as a Home Assistant component | 3.4.3 | https://github.com/JurajNyiri/HomeAssistant-Tapo-Control
...
Card Mod | 🔹 Add CSS styles to (almost) any lovelace card | 3.1.1 | https://github.com/thomasloven/lovelace-card-mod
...
Light Popup Card (Homekit Style) | Lovelace card to use as custom pop-up for light in homekit style | 0.5 | https://github.com/DBuit/light-popup-card
Mini Graph Card | Minimalistic graph card for Home Assistant Lovelace UI | v0.10.0 | https://github.com/kalkih/mini-graph-card
Mini Media Player | Minimalistic media card for Home Assistant Lovelace UI | v1.15.0 | https://github.com/kalkih/mini-media-player
...
Person | Minimalist plugin which allows users to add person entity in order to show the location with a beutiful and clean interface. | v0.7.3 | https://github.com/gerardag/person-entity-card
Search Card | Quickly search for entities from a Lovelace card. | None | https://github.com/postlund/search-card
Simple Weather Card | Minimalistic weather card for Home Assistant | v0.8.2 | https://github.com/kalkih/simple-weather-card
Slider Button Card | A button card with integrated slider | v1.10.3 | https://github.com/mattieha/slider-button-card
State Switch | 🔹Dynamically replace lovelace cards depending on occasion | 1.9.1 | https://github.com/thomasloven/lovelace-state-switch
